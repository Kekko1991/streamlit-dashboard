...
# HEADER
st.markdown("""<h1 style='font-size: 36px; color: #00BFFF;'>💼 Finance Dashboard con Schede</h1>""", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    # TABS
    tab1, tab2, tab3 = st.tabs(["📊 KPI + Grafici", "📋 Dati", "⬇️ Esportazione"])
